 ...
 * @since 01-06-2015
 */
package ica.han.oose.project.overhoorapp.json.models.topics.create;
...
public class Topic implements Serializable {
    ...
    public TopicId toTopicId() {
        final ica.han.oose.project.overhoorapp.json.models.summaries.read.TopicId topic = new ica.han.oose.project.overhoorapp.json.models.summaries.read.TopicId();
