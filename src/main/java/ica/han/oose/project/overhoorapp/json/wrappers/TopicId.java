...
/**
 * Provide a wrapper class for TopicIds.
 *
...
public class TopicId {
     ...
     */
    private ica.han.oose.project.overhoorapp.json.models.summaries.read.TopicId topic;
     ...
     */
    public TopicId(final ica.han.oose.project.overhoorapp.json.models.summaries.read.TopicId topic) {
        this.topic = topic;
    }
     ...
     * @return The TopicId.
     */
    public ica.han.oose.project.overhoorapp.json.models.summaries.read.TopicId getTopic() {
        return topic;
    }
    ...
    public List<TagElement> getTags() {
        return topic.getTags() != null && topic.getTags().length > 0 ? Arrays.asList(topic.getTags()) : new ArrayList<TagElement>();
    }
    ...
    public Topic getTopicObject() {
        final TopicElement ele = new TopicElement();
